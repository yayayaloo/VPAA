...
const LoginPage = () => {
  ...
  const handleLogin = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const isFirstLogin =
        profile?.isFirstLogin === true || profile?.is_first_login === true;
  ...
  return (
    <div className="flex flex-col items-center">
      <div className="mb-8 flex flex-col items-center">
        ...
        <p className="text-[10px] uppercase tracking-[0.2em] text-sidebar/60 font-bold mb-8">
          VPAA RANKING PORTAL
        </p>
      ...
      <div className="mt-12 text-[10px] text-slate-400 font-medium">
        (c) 2026 Gordon College. All rights reserved.
      </div>
    </div>
  );
};
